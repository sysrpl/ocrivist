...
type
  ...
  function sane_init (version_code: PSANE_Int; authorize: Pointer): SANE_Status; cdecl; external SaneExport;
  procedure sane_exit;  cdecl; external SaneExport;
  function sane_get_devices ( devices: PDeviceArray; local_only: SANE_Bool): SANE_Status; cdecl; external SaneExport;
